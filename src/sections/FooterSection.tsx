...
export default function FooterSection() {
  ...
  useEffect(() => {
    ...
    // Marquee animation
    const m1 = marqueeRef.current.querySelector<HTMLElement>('.marquee-inner');
    if (!m1) return;
        ...
        <div className="flex flex-col md:flex-row flex-wrap border-b border-black/50">
          <div className="footer-mod flex-1 min-w-[200px] p-5 border-b md:border-b-0 md:border-r border-black/50 flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] uppercase text-fog/50" id="footer-clock">
                00:00:00
              </span>
            </div>
          </div>
          ...
          <div className="footer-mod p-8 md:p-12 flex flex-col justify-between">
            <div>
              <div className="grid grid-cols-2 gap-8 mb-8">
                <div>
                  <span className="block font-mono text-[9px] tracking-[0.2em] uppercase text-saffron/50 mb-5">
                    Company
                  </span>
                  <ul className="space-y-3 text-sm text-fog/70">
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/about">
                        About
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/case-studies">
                        Case Studies
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/portfolio">
                        Portfolio
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/careers">
                        Careers
                      </a>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-sm text-fog/70">
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/ai-automation">
                        AI Automation
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/web-development">
                        Web Development
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/mobile-app-development">
                        Mobile Apps
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/saas-development">
                        SaaS
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/ui-ux-design">
                        UI UX
                      </a>
                    </li>
                  </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <ul className="space-y-3 text-sm text-fog/70">
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/blog">
                        Blogs
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="#faq">
                        FAQ
                      </a>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-sm text-fog/70">
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/privacy">
                        Privacy
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-parchment transition-colors" href="/terms">
                        Terms
                      </a>
                    </li>
                  </ul>
            ...
            <div className="marquee-inner flex whitespace-nowrap relative z-10">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="flex items-center">
                  <span className="font-display text-3xl md:text-5xl px-8 uppercase italic tracking-tighter cursor-default hover:skew-x-6 transition-transform duration-500">
                    Creative Architecture
                  </span>
                  <span className="w-2 h-2 bg-obsidian rounded-full mx-3" />
                  <span className="font-display text-3xl md:text-5xl px-8 uppercase tracking-tighter cursor-default hover:skew-x-6 transition-transform duration-500">
                    Digital Solutions
                  </span>
                  <span className="w-2 h-2 bg-obsidian rounded-full mx-3" />
                </div>
        ...
        <div className="footer-mod relative py-16 md:py-28 px-6 flex flex-col items-center justify-center text-center group/logo overflow-hidden pb-safe">
          ...
          <div className="mt-12 md:mt-16 flex flex-col md:flex-row items-center justify-between gap-6 w-full max-w-3xl px-4 opacity-50 hover:opacity-100 transition-opacity duration-500 relative z-10">
            <div className="flex flex-col items-start">
              <span className="font-mono text-[8px] uppercase tracking-widest text-saffron/60">
                Status
              </span>
              <span className="font-mono text-[9px] uppercase text-fog/60">
                All Systems Nominal
              </span>
            </div>
